import { getCurrentInstance, version, toRef, isRef, hasInjectionContext, inject, defineAsyncComponent, computed, useSSRContext, unref, watch, h, ref, watchEffect, defineComponent, resolveComponent, reactive, mergeProps, createVNode, resolveDynamicComponent, withCtx, renderSlot, withAsyncContext, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, createTextVNode, renderList, createApp, provide, onErrorCaptured, onServerPrefetch, shallowRef, isReadonly, isShallow, isReactive, toRaw, nextTick, createElementBlock, onScopeDispose, Suspense, Transition } from 'vue';
...
import { withoutTrailingSlash, withLeadingSlash, joinURL, hasProtocol, parseURL, parseQuery, withBase, withTrailingSlash } from 'ufo';
...
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./_nuxt/DocumentDrivenNotFound-9b0c148b.mjs').then((r) => r.default));
const LazyEllipsis = defineAsyncComponent(() => import('./_nuxt/Ellipsis-e719c084.mjs').then((r) => r.default));
...
const LazyDocsAside = defineAsyncComponent(() => import('./_nuxt/DocsAside-d5e50592.mjs').then((r) => r.default));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(function() {
  return DocsAsideTree;
}).then((r) => r.default));
const LazyDocsPageBottom = defineAsyncComponent(() => import('./_nuxt/DocsPageBottom-ef782bb4.mjs').then((r) => r.default));
const LazyDocsPageLayout = defineAsyncComponent(() => import('./_nuxt/DocsPageLayout-fe121164.mjs').then((r) => r.default));
const LazyDocsPrevNext = defineAsyncComponent(() => import('./_nuxt/DocsPrevNext-6ed815e5.mjs').then((r) => r.default));
const LazyDocsToc = defineAsyncComponent(() => import('./_nuxt/DocsToc-7574150e.mjs').then((r) => r.default));
const LazyDocsTocLinks = defineAsyncComponent(() => import('./_nuxt/DocsTocLinks-5f7b5ce0.mjs').then((r) => r.default));
const LazyEditOnLink = defineAsyncComponent(() => import('./_nuxt/EditOnLink-c30adf5b.mjs').then((r) => r.default));
const LazySourceLink = defineAsyncComponent(() => import('./_nuxt/SourceLink-c41d1f12.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-1ece2fe5.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-b2bb844d.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./_nuxt/ProseCode-b9ee977c.mjs').then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-395c77cf.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-d99a0510.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-955e53f9.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-e2781087.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-0241c84a.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-978943bf.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-5b9344c6.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-2969073c.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-e39624e3.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-5631fd46.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-a1e6c13e.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-ce083365.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-595b693f.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-a8ab1a53.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-4197774b.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-e631a502.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-bac4e8d7.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-1466a3f5.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-4a2e0021.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-06112287.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-ccbf3ef4.mjs').then((r) => r.default));
const LazyAlert = defineAsyncComponent(() => import('./_nuxt/Alert-8ef65525.mjs').then((r) => r.default));
const LazyBadge = defineAsyncComponent(() => import('./_nuxt/Badge-b0cab813.mjs').then((r) => r.default));
const LazyButtonLink = defineAsyncComponent(() => import('./_nuxt/ButtonLink-beb27be8.mjs').then((r) => r.default));
const LazyCallout = defineAsyncComponent(() => import('./_nuxt/Callout-0f90903e.mjs').then((r) => r.default));
const LazyCodeBlock = defineAsyncComponent(() => import('./_nuxt/CodeBlock-4b236493.mjs').then((r) => r.default));
const LazyCodeGroup = defineAsyncComponent(() => import('./_nuxt/CodeGroup-469e04e8.mjs').then((r) => r.default));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Container;
}).then((r) => r.default));
const LazyCopyButton = defineAsyncComponent(() => import('./_nuxt/CopyButton-d3b36fc2.mjs').then((r) => r.default));
const LazyList = defineAsyncComponent(() => import('./_nuxt/List-e27b236f.mjs').then((r) => r.default));
const LazyNuxtImg = defineAsyncComponent(() => import('./_nuxt/NuxtImg-b44771e4.mjs').then((r) => r.default));
const LazyProps = defineAsyncComponent(() => import('./_nuxt/Props-f5aab36c.mjs').then((r) => r.default));
const LazySandbox = defineAsyncComponent(() => import('./_nuxt/Sandbox-f0150de6.mjs').then((r) => r.default));
const LazyTabsHeader = defineAsyncComponent(() => import('./_nuxt/TabsHeader-4cfe3476.mjs').then((r) => r.default));
const LazyTerminal = defineAsyncComponent(() => import('./_nuxt/Terminal-be009126.mjs').then((r) => r.default));
const LazyVideoPlayer = defineAsyncComponent(() => import('./_nuxt/VideoPlayer-745f568d.mjs').then((r) => r.default));
const LazyIconCodeSandBox = defineAsyncComponent(() => import('./_nuxt/IconCodeSandBox-07b15c85.mjs').then((r) => r.default));
const LazyIconDocus = defineAsyncComponent(() => import('./_nuxt/IconDocus-f6c75f81.mjs').then((r) => r.default));
const LazyIconNuxt = defineAsyncComponent(() => import('./_nuxt/IconNuxt-32a066bc.mjs').then((r) => r.default));
const LazyIconNuxtContent = defineAsyncComponent(() => import('./_nuxt/IconNuxtContent-d9da73f1.mjs').then((r) => r.default));
const LazyIconNuxtLabs = defineAsyncComponent(() => import('./_nuxt/IconNuxtLabs-37dbf78b.mjs').then((r) => r.default));
const LazyIconNuxtStudio = defineAsyncComponent(() => import('./_nuxt/IconNuxtStudio-5783f66b.mjs').then((r) => r.default));
const LazyIconStackBlitz = defineAsyncComponent(() => import('./_nuxt/IconStackBlitz-82ca89a9.mjs').then((r) => r.default));
const LazyIconVueTelescope = defineAsyncComponent(() => import('./_nuxt/IconVueTelescope-dda568d7.mjs').then((r) => r.default));
const LazyBlockHero = defineAsyncComponent(() => import('./_nuxt/BlockHero-f9076078.mjs').then((r) => r.default));
const LazyCard = defineAsyncComponent(() => import('./_nuxt/Card-cfaeeba0.mjs').then((r) => r.default));
const LazyCardGrid = defineAsyncComponent(() => import('./_nuxt/CardGrid-1dedbddf.mjs').then((r) => r.default));
const LazyVoltaBoard = defineAsyncComponent(() => import('./_nuxt/VoltaBoard-98820156.mjs').then((r) => r.default));
const LazyComponentPlayground = defineAsyncComponent(() => import('./_nuxt/ComponentPlayground-cd6b9349.mjs').then((r) => r.default));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import('./_nuxt/ComponentPlaygroundData-c6b10f3c.mjs').then((r) => r.default));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import('./_nuxt/ComponentPlaygroundProps-3c0999c2.mjs').then((r) => r.default));
...
const LazyPreviewLayout = defineAsyncComponent(() => import('./_nuxt/PreviewLayout-9d259ea7.mjs').then((r) => r.default));
const LazyTokensPlayground = defineAsyncComponent(() => import('./_nuxt/TokensPlayground-10a3675b.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-186ba2e5.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-628530bf.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-a820a3b1.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-f246a0b9.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-32edd6cb.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-d32bb864.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./_nuxt/ContentSlot-e754006a.mjs').then((r) => r.default));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./_nuxt/DocumentDrivenEmpty-e7fcdb87.mjs').then((r) => r.default));
const LazyMarkdown = defineAsyncComponent(() => import('./_nuxt/Markdown-35261ea5.mjs').then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-85823a94.mjs').then((r) => r.default));
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/document-driven-ba0105a0.mjs').then((m) => m.default || m)
  }
];
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./_nuxt/client-db-3f582cbc.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./_nuxt/client-db-3f582cbc.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: () => import('./_nuxt/default-90ae0de9.mjs').then((m) => m.default || m),
  page: () => import('./_nuxt/page-a4652dd9.mjs').then((m) => m.default || m)
};
...
const __nuxt_component_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["__scopeId", "data-v-2596513f"]]);
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-e610b8e3"]]);
...
const __nuxt_component_3$1 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-9970c548"]]);
...
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-d42239fd"]]);
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_DocsAsideTree = __nuxt_component_0$3;
      _push(`<!--[--><button aria-label="Menu" data-v-ccd3bf62>`);
      _push(ssrRenderComponent(_component_Icon, {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(visible)) {
          _push2(`<nav class="dialog" data-v-ccd3bf62><div data-v-ccd3bf62><div class="wrapper" data-v-ccd3bf62><button aria-label="Menu" data-v-ccd3bf62>`);
          _push2(ssrRenderComponent(_component_Icon, {
            name: "heroicons-outline:x",
            "aria-hidden": "”true”"
          }, null, _parent));
          _push2(`</button><div class="icons" data-v-ccd3bf62>`);
...
const __nuxt_component_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-ccd3bf62"]]);
...
const __nuxt_component_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-fca4477e"]]);
...
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-58a8631e"]]);
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-4fab471c"]]);
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_0$4;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "doc-search" }, _attrs))} data-v-467a326b><button type="button" aria-label="Search" data-v-467a326b><span class="content" data-v-467a326b>`);
      _push(ssrRenderComponent(_component_Icon, { name: "heroicons-outline:search" }, null, _parent));
      _push(`<span data-v-467a326b>Search</span><span data-v-467a326b><kbd data-v-467a326b>⌘</kbd><kbd data-v-467a326b>K</kbd></span></span></button></div>`);
    };
  }
});
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__scopeId", "data-v-467a326b"]]);
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-87324333"]]);
      ...
      _push(ssrRenderComponent(_component_Container, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="section center" data-v-928835ca${_scopeId}>`);
            if (unref(hasDialog)) {
              _push2(ssrRenderComponent(_component_AppHeaderLogo, null, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            ...
            _push2(`</div><div class="section right" data-v-928835ca${_scopeId}>`);
            ...
            _push2(`<div class="social-icons" data-v-928835ca${_scopeId}>`);
...
const __nuxt_component_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-928835ca"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_0$4;
      const _component_AppSocialIcons = __nuxt_component_3$1;
      _push(`<footer${ssrRenderAttrs(_attrs)} data-v-e96e3bbb>`);
      _push(ssrRenderComponent(_component_Container, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="left" data-v-e96e3bbb${_scopeId}>`);
            if ((_b2 = (_a2 = unref(config)) == null ? void 0 : _a2.footer) == null ? void 0 : _b2.credits) {
              _push2(`<a${ssrRenderAttr("href", ((_e = (_d = (_c = unref(config)) == null ? void 0 : _c.footer) == null ? void 0 : _d.credits) == null ? void 0 : _e.href) || "#")} rel="noopener" target="_blank" data-v-e96e3bbb${_scopeId}>`);
              ...
              if ((_n = (_m = (_l = unref(config)) == null ? void 0 : _l.footer) == null ? void 0 : _m.credits) == null ? void 0 : _n.text) {
                _push2(`<p data-v-e96e3bbb${_scopeId}>${ssrInterpolate(unref(config).footer.credits.text)}</p>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</a>`);
            ...
            _push2(`</div><div class="center" data-v-e96e3bbb${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></div><div class="right" data-v-e96e3bbb${_scopeId}><!--[-->`);
            ssrRenderList(unref(icons).slice(0, 6 - unref(nbSocialIcons)), (icon) => {
              _push2(`<a class="icon-link"${ssrRenderAttr("aria-label", icon.label)}${ssrRenderAttr("href", icon.href)} target="_blank"${ssrRenderAttr("rel", (icon == null ? void 0 : icon.rel) || "noopener noreferrer")} data-v-e96e3bbb${_scopeId}>`);
              _push2(ssrRenderComponent(_component_Icon, {
                name: icon.icon
              }, null, _parent2, _scopeId));
              _push2(`</a>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e96e3bbb"]]);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-5c2f7786"]]);
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-8656807b.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-c9847904.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { useRequestEvent as A, get$1 as B, assertArray as C, ensureArray as D, sortList as E, apply as F, withoutKeys as G, withKeys as H, createQuery as I, useHead as J, _export_sfc as _, useAppConfig as a, __nuxt_component_0$4 as b, createError as c, __nuxt_component_0$6 as d, entry$1 as default, computedStyle as e, useUnwrap as f, useDocus as g, __nuxt_component_0$3 as h, useContent as i, useRoute as j, useState as k, __nuxt_component_0$5 as l, useContentHelpers as m, useRouter as n, useRuntimeConfig as o, useNuxtApp as p, useColorMode as q, usePinceauTheme as r, useContentHead as s, queryContent as t, usePinceauRuntime as u, useContentPreview as v, fetchContentNavigation as w, layouts as x, appLayoutTransition as y, _wrapIf as z };
