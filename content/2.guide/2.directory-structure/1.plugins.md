...
Only `myPlugin.ts` and `myOtherPlugin/index.ts` would be registered. You can configure [`plugins`](/api/configuration/nuxt-config#plugins-1) to include unscanned files.
