...
Once you've read the [general contribution guide](/community/contribution), here are some specific points to make about contributions to the `nuxt/nuxt` repository.
...
- [Learn more about this package](/guide/going-further/kit).
...
- Published as: `nuxi`
- [Learn more about this package](/api/commands/add).
...
- [Learn more about this package](/api/configuration/nuxt-config#vite).
...
- [Learn more about this package](/api/configuration/nuxt-config#webpack-1).
